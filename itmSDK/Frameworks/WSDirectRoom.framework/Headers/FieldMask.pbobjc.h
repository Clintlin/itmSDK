...
#pragma mark - AIYOU_G_P_BFieldMaskRoot
 ...
 **/
@interface AIYOU_G_P_BFieldMaskRoot : AIYOU_G_P_BRootObject
@end

#pragma mark - AIYOU_G_P_BFieldMask

typedef AIYOU_G_P_B_ENUM(AIYOU_G_P_BFieldMask_FieldNumber) {
  AIYOU_G_P_BFieldMask_FieldNumber_PathsArray = 1,
};
 ...
 * paths.
 **/
@interface AIYOU_G_P_BFieldMask : AIYOU_G_P_BMessage
