...
#pragma mark - AIYOU_G_P_BAnyRoot
 ...
 **/
@interface AIYOU_G_P_BAnyRoot : AIYOU_G_P_BRootObject
@end

#pragma mark - AIYOU_G_P_BAny

typedef AIYOU_G_P_B_ENUM(AIYOU_G_P_BAny_FieldNumber) {
  AIYOU_G_P_BAny_FieldNumber_TypeURL = 1,
  AIYOU_G_P_BAny_FieldNumber_Value = 2,
};
 ...
 *     }
 **/
@interface AIYOU_G_P_BAny : AIYOU_G_P_BMessage
