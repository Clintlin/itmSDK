...
#pragma mark - AIYOU_G_P_BTimestampRoot
 ...
 **/
@interface AIYOU_G_P_BTimestampRoot : AIYOU_G_P_BRootObject
@end

#pragma mark - AIYOU_G_P_BTimestamp

typedef AIYOU_G_P_B_ENUM(AIYOU_G_P_BTimestamp_FieldNumber) {
  AIYOU_G_P_BTimestamp_FieldNumber_Seconds = 1,
  AIYOU_G_P_BTimestamp_FieldNumber_Nanos = 2,
};
 ...
 **/
@interface AIYOU_G_P_BTimestamp : AIYOU_G_P_BMessage
