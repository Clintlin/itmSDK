...
#pragma mark - AIYOU_G_P_BDurationRoot
 ...
 **/
@interface AIYOU_G_P_BDurationRoot : AIYOU_G_P_BRootObject
@end

#pragma mark - AIYOU_G_P_BDuration

typedef AIYOU_G_P_B_ENUM(AIYOU_G_P_BDuration_FieldNumber) {
  AIYOU_G_P_BDuration_FieldNumber_Seconds = 1,
  AIYOU_G_P_BDuration_FieldNumber_Nanos = 2,
};
 ...
 **/
@interface AIYOU_G_P_BDuration : AIYOU_G_P_BMessage
